...
<!-- section -->
	<div class="section">
		...
		<div class="container">
			<!-- row -->
			<div class="row">
				<form id="checkout-form" class="clearfix" action="InserisciAnnuncioController" method="post" enctype="multipart/form-data">
					<div class="col-md-3">
					</div>
					...
					<div class="col-md-6">
						<div class="billing-details">
							<div class="section-title">
								<h3 class="title">Insersci il tuo  annuncio</h3>
							</div>
							...
							<div class="form-group">
								...
								<input class="input" type="number" name="prezzo" placeholder="scrivi il prezzo del veicolo" min="0" step="0.5" required autofocus>
							</div> 
														
							<div class="form-group">
								<button class="primary-btn"  id="InsAnnuncio">Inserisci annuncio </button>
							</div>
